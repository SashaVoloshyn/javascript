...
//     divMember.appendChild(divInfo);
//     divMember.appendChild(sImg);
...
for (const item of coursesArray) {
    ...
    flexDiv.style.columnGap = '60px';

    let mounth = document.createElement('div');
    mounth.innerText = item.monthDuration;
    ...
    wrap.appendChild(flexDiv);
    flexDiv.appendChild(mounth);
    flexDiv.appendChild(hour);
